...
public class MazeGeneratorDFSParallel extends JPanel {
    private int rows;
    private int cols;
    ...
    public MazeGeneratorDFSParallel(int rows, int cols, int cellSize) {
        this.rows = rows;
        this.cols = cols;
    ...
    private void dfsParallel(int i, int j, ExecutorService executor) {
        ...
        for (int direction : directions) {
            ...
            int finalNi = ni;
            int finalNj = nj;
            executor.submit(() -> dfsParallel(finalNi, finalNj, executor));
        }
    }
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Concurrent Maze Generator");
